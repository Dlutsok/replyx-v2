...
• ОБЯЗАТЕЛЬНО обращение к клиентам на «ВЫ», а НЕ на «ты» (говорите "Проверьте", "Обратитесь", "Попробуйте", а НЕ "Проверь", "Обратись", "Попробуй")
...
Принципы работы:
• Вежливое и профессиональное обращение НА «ВЫ» (говорите клиентам "Проверьте", "Убедитесь", а НЕ "Проверь", "Убедись")
