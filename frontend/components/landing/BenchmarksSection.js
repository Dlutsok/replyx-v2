...
const BenchmarksSection = () => {
  ...
  const tabContent = [
    {
      ...
      description: 'Достаточно загрузить документы, инструкции, каталоги и описание услуг — и AI-ассистент ReplyX подстроится под специфику именно вашей компании. Он мгновенно отвечает на вопросы, знает ваши продукты и услуги, обрабатывает до 100 000 страниц данных в реальном времени.',
      features: [
    ...
    },
    {
      ...
      description: 'AI-ассистент ReplyX легко адаптируется под фирменный стиль вашей компании. Виджет на сайт можно настроить без программистов: добавить логотип, выбрать корпоративные цвета, задать приветственное сообщение. Он становится частью вашего бренда и органично смотрится как на десктопе, так и на мобильных версиях сайта.',
      features: [
        'Брендированный чат-бот на сайт',
        'Настройка виджета для сайта без программистов',
        'Кастомизация цвета виджета',
        'Добавление логотипа и корпоративного стиля',
        'Адаптация под мобильные и десктоп версии'
      ]
    },
    {
      title: 'Запуск за 15 минут без программистов',
      subtitle: 'Универсальная интеграция',
      description: 'Запустите AI-ассистента ReplyX за 15 минут — без программистов и сложной интеграции. Виджет совместим с любыми платформами: WordPress, Bitrix24, Joomla, Tilda, Shopify или custom HTML. Универсальная интеграция позволяет подключить чат-бота к любому сайту и сразу начать автоматизацию поддержки клиентов.',
      features: [
        'Совместимость с CMS WordPress, Bitrix, Joomla, Tilda',
        'Интеграция чат-бота без программистов',
        'Установка виджета за 15 минут',
        'Поддержка мобильных и десктоп версий сайта',
        'Автоматизация поддержки клиентов сразу после установки'
      ]
    },
    {
      title: 'AI в Telegram',
      subtitle: 'Умный ассистент для мессенджера',
      description: 'Интеграция ReplyX с Telegram превращает ваш мессенджер в полноценный канал поддержки. AI-ассистент отвечает на вопросы клиентов мгновенно, обрабатывает текстовые и голосовые сообщения, даёт персонализированные консультации. Подключение к Telegram Bot API занимает несколько минут и позволяет обслуживать клиентов там, где им удобнее всего.',
      features: [
        'AI-чатбот в Telegram для поддержки клиентов',
        'Поддержка клиентов в мессенджере 24/7',
        'Обработка текстовых и голосовых сообщений',
        'Персонализированные консультации в Telegram',
        'Интеграция с Telegram Bot API без программистов'
      ]
    },
    {
      title: 'Аналитика и отчёты',
      subtitle: 'Детальная статистика работы',
      description: 'ReplyX предоставляет детальную аналитику и отчёты по каждому обращению. Система показывает количество диалогов, время ответа, популярные вопросы и эффективность поддержки. Это помогает компаниям измерять качество обслуживания и оптимизировать бизнес-процессы. Подробная статистика доступна прямо в личном кабинете без дополнительных интеграций.',
      features: [
        'Отчёты по обращениям AI-ассистента',
        'Статистика чат-бота и эффективность поддержки',
        'Анализ времени ответа на вопросы клиентов',
        'Популярные вопросы и темы обращений',
    ...
    },
    {
      ...
      description: 'ReplyX не заменяет операторов, а усиливает их работу. AI автоматически распознаёт сложные запросы и передаёт их специалистам вместе с полной историей диалога. Это экономит время, снижает нагрузку на команду и исключает повторные объяснения со стороны клиента. Система поддерживает умную маршрутизацию и ручное подключение через интерфейс.',
      features: [
        'Умная маршрутизация чатов к операторам',
        'Гибридная поддержка AI + оператор',
        'Автоматическое распознавание сложных запросов',
        'Передача полной истории диалога специалистам',
  ...
  return (
    <section id="features" className="relative min-h-[600px] md:min-h-[700px] flex items-center overflow-hidden pb-20 lg:pt-16" style={{paddingBottom: '4rem'}}>
      {/* White background */}
      ...
      <div className={`max-w-1200 mx-auto ${DESIGN_TOKENS.spacing.containerPadding} w-full relative`}>
        ...
        >
          ...
          <p className={`${DESIGN_TOKENS.typography.sectionSubtitle} mt-3 lg:mt-4 text-sm lg:text-base xl:text-lg`}>
            ReplyX — универсальный AI-ассистент для бизнеса. Подходит для интернет-магазинов, медицинских клиник, образовательных проектов и корпоративного сектора. Автоматизирует поддержку клиентов 24/7 и снижает расходы на операторов до 70%.
          </p>
        </motion.div>
