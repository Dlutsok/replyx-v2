      ...
      <div className={`${DESIGN_TOKENS.spacing.maxWidth} ${DESIGN_TOKENS.spacing.containerPadding}`}>
        ...
        >
          ...
          <p className={`${DESIGN_TOKENS.typography.sectionSubtitle}`}>
            ReplyX используется в разных сферах: e-commerce, IT, медицина, образование, сервисные компании. Внедрение AI-ассистента увеличивает продажи, сокращает нагрузку на операторов и повышает эффективность поддержки клиентов в 3–4 раза.
          </p>
        </motion.div>
