        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'development' 
              ? "frame-ancestors 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://yookassa.ru https://*.yoomoney.ru https://mc.yandex.ru; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://yookassa.ru https://*.yoomoney.ru; font-src 'self' https://fonts.gstatic.com data:; frame-src 'self' https://yookassa.ru https://*.yoomoney.ru; connect-src 'self' http://localhost:* https: wss: ws: https://yookassa.ru https://*.yoomoney.ru https://mc.yandex.ru; img-src 'self' data: https://mc.yandex.ru;" 
              : "frame-ancestors 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://yookassa.ru https://*.yoomoney.ru https://mc.yandex.ru; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://yookassa.ru https://*.yoomoney.ru; font-src 'self' https://fonts.gstatic.com data:; frame-src 'self' https://yookassa.ru https://*.yoomoney.ru; connect-src 'self' https: wss: ws: https://yookassa.ru https://*.yoomoney.ru https://mc.yandex.ru; img-src 'self' data: https://mc.yandex.ru;",
          },
        ],
      },
    ];
