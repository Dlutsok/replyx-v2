    ...
    <header className={landingStyles.header}>
      <div className={landingStyles.headerContainer}>
        ...
        <div className={landingStyles.headerActions}>
          ...
          <button
            className="px-6 py-2.5 text-white font-semibold rounded-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#6334E5]/30 h-11 relative overflow-hidden"
          ...
          <div style={{
            ...
            <div style={{
              ...
              <section style={{marginBottom: isMobile ? '1.5rem' : '2rem'}}>
                ...
                <p style={{marginBottom: '0.8rem'}}><strong>5.2.</strong> Пробный лимит: предоставляется 100 сообщений бесплатно для первичного тестирования.</p>
