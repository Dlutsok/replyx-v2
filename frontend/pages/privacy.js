            ...
            <div style={{lineHeight: '1.6', color: '#374151'}}>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>
                  ...
                  персональных данных пользователей сервиса ReplyX (далее — «Сервис», «мы», «нас» или «наш»).
                </p>
                <p>
                  Мы серьезно относимся к защите вашей конфиденциальности и стремимся обеспечивать безопасность
                  ваших персональных данных в соответствии с действующим законодательством Российской Федерации,
                  в частности Федеральным законом № 152-ФЗ «О персональных данных».
                </p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>Мы можем собирать следующие категории персональных данных:</p>
                ...
                <ul style={{margin: '0.5rem 0', paddingLeft: '1.5rem'}}>
                  <li style={{marginBottom: '0.5rem'}}>Адрес электронной почты</li>
                  <li style={{marginBottom: '0.5rem'}}>Имя пользователя</li>
                  <li style={{marginBottom: '0.5rem'}}>Пароль (в зашифрованном виде)</li>
                  <li style={{marginBottom: '0.5rem'}}>Yandex ID (при авторизации через Яндекс)</li>
                  <li>Сообщения и запросы к AI-ассистентам</li>
                </ul>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>Мы обрабатываем ваши персональные данные для следующих целей:</p>
                <ul style={{margin: '0.5rem 0', paddingLeft: '1.5rem'}}>
                  <li style={{marginBottom: '0.5rem'}}>Предоставление доступа к сервису и его функциям</li>
                  <li style={{marginBottom: '0.5rem'}}>Обработка платежей и управление балансом</li>
                  <li style={{marginBottom: '0.5rem'}}>Генерация ответов AI-ассистентов</li>
                  <li style={{marginBottom: '0.5rem'}}>Обеспечение безопасности и предотвращение мошенничества</li>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <ul style={{margin: '0.5rem 0', paddingLeft: '1.5rem'}}>
                  <li style={{marginBottom: '0.5rem'}}>Шифрование данных в транзите и хранении</li>
                  <li style={{marginBottom: '0.5rem'}}>Ограничение доступа к данным</li>
                  <li style={{marginBottom: '0.5rem'}}>Регулярные аудиты безопасности</li>
              ...
              <section>
                ...
                <p style={{marginBottom: '1rem'}}>
                  Если у вас есть вопросы по настоящей Политике или обработке ваших персональных данных,
                ...
                <div style={{
                  ...
                  <p style={{margin: '0.5rem 0', fontWeight: '500'}}>
                    <strong>Email:</strong> privacy@replyx.ru
                  </p>
                  <p style={{margin: '0.5rem 0', fontWeight: '500'}}>
