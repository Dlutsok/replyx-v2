...
export default function TermsOfService() {
  ...
  return (
    <>
      <Head>
        <title>Пользовательское Соглашение - ReplyX</title>
        <meta name="description" content="Пользовательское соглашение сервиса ReplyX. Правила использования платформы и условия предоставления услуг." />
        ...
        <div style={containerStyle}>
          <div style={contentStyle}>
            <h1 style={{
              ...
              Пользовательское Соглашение ReplyX
            </h1>
            ...
            <div style={{lineHeight: '1.6', color: '#374151'}}>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>
                  ...
                  владельцем сервиса ReplyX (далее — «Сервис», «мы», «нас» или «Администрация») и
                  пользователем сервиса (далее — «Пользователь» или «вы»).
                </p>
                <p style={{marginBottom: '1rem'}}>
                  1.2. Сервис предоставляет доступ к искусственному интеллекту для генерации ответов,
                  создания контента и автоматизации коммуникаций.
                </p>
                <p>
                  1.3. Используя Сервис, вы соглашаетесь с условиями настоящего Соглашения.
                </p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>2.1. Для использования Сервиса необходимо создать аккаунт путем регистрации.</p>
                <p style={{marginBottom: '1rem'}}>2.2. При регистрации вы обязаны предоставить достоверную информацию.</p>
                <p style={{marginBottom: '1rem'}}>2.3. Вы несете ответственность за конфиденциальность своих учетных данных.</p>
                <p>2.4. Администрация имеет право заблокировать аккаунт при нарушении правил.</p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>3.1. Запрещается использовать Сервис для:</p>
                <ul style={{margin: '0.5rem 0', paddingLeft: '1.5rem'}}>
                  <li style={{marginBottom: '0.5rem'}}>Генерации противоправного контента</li>
                  <li style={{marginBottom: '0.5rem'}}>Распространения вредоносного ПО</li>
                  <li style={{marginBottom: '0.5rem'}}>Нарушения прав третьих лиц</li>
                  <li style={{marginBottom: '0.5rem'}}>Спама и массовых рассылок</li>
                  <li>Любых незаконных действий</li>
                </ul>
                <p style={{marginBottom: '1rem'}}>3.2. Вы обязаны использовать Сервис только в личных или коммерческих целях.</p>
                <p>3.3. Запрещается пытаться взломать или обойти ограничения Сервиса.</p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>
                  4.1. Все права на Сервис и его компоненты принадлежат Администрации.
                </p>
                <p style={{marginBottom: '1rem'}}>
                  4.2. Контент, генерируемый AI, может использоваться вами свободно, но Администрация
                  не несет ответственности за его содержание.
                </p>
                <p>
                  4.3. Запрещается копирование, модификация или реверс-инжиниринг Сервиса.
                </p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>
                  5.2. Администрация не несет ответственности за косвенные убытки.
                </p>
                <p style={{marginBottom: '1rem'}}>
                  5.3. Максимальная ответственность ограничивается суммой оплаты за последний месяц.
                </p>
                <p>
                  5.4. Мы не гарантируем бесперебойную работу Сервиса.
                </p>
              </section>
              ...
              <section style={{marginBottom: '2rem'}}>
                ...
                <p style={{marginBottom: '1rem'}}>
                  6.1. Вы можете прекратить использование Сервиса в любое время.
                </p>
                <p style={{marginBottom: '1rem'}}>
                  6.2. Администрация может прекратить доступ при нарушении правил.
                </p>
                <p>
                  6.3. При прекращении все ваши данные могут быть удалены.
                </p>
              </section>
              ...
              <section>
                ...
                <p style={{marginBottom: '1rem'}}>
                  7.1. Администрация имеет право изменять условия Соглашения.
                </p>
                <p style={{marginBottom: '1rem'}}>
                  7.2. Об изменениях будет сообщено через email или уведомления в Сервисе.
                </p>
                <p>
                  7.3. Продолжение использования означает согласие с изменениями.
                </p>
              </section>
            </div>
          </div>
